...
void WebSite::Init(ApplicationNS::tTaskObjects* apTaskObjects)
{
    ...
    mWebUIControlID.mMainTab     = Control::noParent; //ESPUI.addControl(Control::Type::Tab, "", "Wordclock", Control::Color::None, Control::noParent);
    mWebUIControlID.mSettingsTab = Control::noParent; //ESPUI.addControl(Control::Type::Tab, "", "Settings",  Control::Color::Wetasphalt, Control::noParent);
